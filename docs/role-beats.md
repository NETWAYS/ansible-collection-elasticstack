...
* *beats_cert_validity_period*: number of days that the generated certificates are valid (default: `not set`). When no value is set, the default of elastic, `1095` days, will be used.
